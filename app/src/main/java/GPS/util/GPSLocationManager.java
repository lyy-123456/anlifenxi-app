...
//        if (ActivityCompat.checkSelfPermission(mContext.get(), android.Manifest.permission.ACCESS_FINE_LOCATION)
//                != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
//                (mContext.get(), android.Manifest.permission.ACCESS_COARSE_LOCATION)
...
//        }
    ...
    private Location getLastKnownLocation() {
        ...
        for (String provider : providers) {
            System.out.println("getLastKnownLocation+"+provider);
            if (ActivityCompat.checkSelfPermission(mContext.get(), android.Manifest.permission.ACCESS_FINE_LOCATION)
                    != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
                    (mContext.get(), android.Manifest.permission.ACCESS_COARSE_LOCATION)
                    != PackageManager.PERMISSION_GRANTED) {
